...
마지막 갱신: 2026-09-25 22:40 UTC (Claude 트랙 R 세션: 8c22f0e 게시 기록(Sites 버전 35), 묶음 13 게시 전 점검 수정, 자동 게시 절차)
...
| 열린 PR | #16 Android(draft, 제외), 8c22f0e 게시 기록·묶음 13 게시 전 점검 수정 PR(브랜치 `claude/franchise-recruitment-marketing-u8cpo2`, 이 갱신과 같은 PR) | GitHub 열린 PR 목록(GitHub MCP), 2026-09-25 21:50 UTC |
