...
마지막 갱신: 2026-09-25 21:50 UTC (Claude 트랙 R 세션: 8c22f0e 게시 기록(Sites 버전 35), 41ea80d 게시 요청 PR, 자동 게시 절차)
...
| `origin/main` | `41ea80d` (#117) | 8c22f0e 뒤 #116(문서)·#117(트랙 R R1b·R2). 41ea80d 게시 요청 PR이 열려 있다(자동 게시, `docs/PUBLISH.ko.md` 8절). 그동안 다른 도구는 새 게시를 요청하지 않는다 |
...
| 열린 PR | #16 Android(draft, 제외), 41ea80d 게시 요청·8c22f0e 게시 기록 PR(브랜치 `claude/franchise-recruitment-marketing-u8cpo2`, 이 갱신과 같은 PR) | GitHub 열린 PR 목록(GitHub MCP), 2026-09-25 21:50 UTC |
| main CI | `41ea80d`·`8ed30d0`·`8c22f0e` passed | GitHub Actions main 실행(API 조회), 2026-09-25 21:5x UTC |
