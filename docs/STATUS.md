...
마지막 갱신: 2026-09-25 15:52 UTC (Claude 트랙 R 세션: R1b 모집 팩트시트·R2 모집 광고 가드레일 PR, 운영 표를 e8bd8e0 게시 기록에 맞춤, 73147a9 게시 기록 추가)

## 현재 운영 상태

| 항목 | 값 | 근거 |
|---|---|---|
| 운영 제품 커밋 | `e8bd8e0724de8427cffdaa80d723583f97814347` (#112 `merged`, 묶음 11: fa9da73 뒤 #108~#112. 트랙 R #101 포함) | 제품 tree `d8eacc92bd85525f93a67a1141b25d4fd0a0e8ca` |
| `origin/main` | `8ed30d0` (#116) | e8bd8e0 뒤 #113~#116. 8c22f0e(#115) 게시 지시문이 대표에게 나가 있다(`docs/HANDOFF.ko.md`). 그동안 다른 도구는 새 게시를 요청하지 않는다 |
| Sites 게시 | `published` (편집기 최종 보고의 Sites 버전·deployment id는 기록 없음), 운영 build 2026-09-25T13:14:48Z, 파일 목록·기대 해시 방식(커넥터, fa9da73→e8bd8e0 22줄) | [게시 기록](releases/2026-09-25-e8bd8e0.md). 그 앞: 121791b(묶음 9)·fa9da73(묶음 10), 트랙 R 단독 게시 73147a9(Sites 버전 31, tree `unknown`) [기록](releases/2026-09-25-73147a9.md) |
| 실행 검증 | `runtime-verified` · real, 2026-09-25 13:48 UTC | 소유자 세션 `/api/version` tree `d8eacc9…` = e8bd8e0 tree(게시 기록) |
...
| 열린 PR | #16 Android(draft, 제외), 트랙 R R1b·R2 PR(브랜치 `claude/franchise-recruitment-marketing-u8cpo2`, 이 갱신과 같은 PR) | GitHub 열린 PR 목록(GitHub MCP), 2026-09-25 15:52 UTC |
| main CI | `8ed30d0`·`8c22f0e`·`0443c9f` passed | GitHub Actions main 실행(API 조회), 2026-09-25 15:52 UTC |
