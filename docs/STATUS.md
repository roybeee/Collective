...
마지막 갱신: 2026-09-24 16:10 UTC (Claude 세션, 조사 의뢰 정보 가림 전송 PR `feat/research-intake-masked`)
...
| `origin/main` | `df7e253` (#76) = 운영 제품 커밋 | 게시 확인 시점 `git diff df7e253 origin/main` 0개 파일 |
...
| 열린 PR | #16 Android(draft, 제외), 이 게시 기록 PR | `gh pr list -R roybeee/Collective`, 2026-09-24 15:10 UTC |
