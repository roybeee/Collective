...
마지막 갱신: 2026-09-24 00:50 UTC (Claude 레인 B 세션, B1·PR 4b-2 병합 반영)
...
| `origin/main` | `d609e9d` (#51) | a64aeef 뒤 **미게시 제품 변경 있음**: #27 F1a·A2, #30 B4 1부, #32 F4a, #33 PR 6 서버 측, #35 F1b-1, #37 PR 5a, #39 F1b-2 서버 평가, #40 PR 5b, #41 동결 요약 표시, #43 F2a, #44 PR 4b-1, #45 F2b, #46 A4-1, #47 PR 6 앱 측, #48 PR 4a, #49 A4-2, #50 A4-3, #51 B1, #52 A2 런타임, #53 PR 4b-2. main 기준 `runtime-verified` 아님 |
...
| 열린 PR | #16 Android(draft, 제외). 레인 A F3a 프롬프트 레지스트리·레인 B A7 조사 수리·부분 구제 진행 중 | `gh pr list -R roybeee/Collective`, 2026-09-24 00:50 UTC |
| main CI(`900cbca`) | passed · verify. `d609e9d`(#51)는 PR CI passed, main 실행 확인 전 | GitHub Actions main 실행 |
