...
마지막 갱신: 2026-09-25 00:37 UTC (Claude 트랙 R 계획 세션, OFD 법률 검토 준비)
...
| `origin/main` | `7b897c9` (#81) | 443fff4 뒤 변경은 #81 게시 기록(문서)뿐이다(`git diff 443fff4 7b897c9`: `docs/` 2개 파일). main 기준 `runtime-verified` 유지 |
...
| 열린 PR | #16 Android(draft, 제외) | GitHub 열린 PR 목록(GitHub MCP), 2026-09-24 19:34 UTC |
