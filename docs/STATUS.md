...
마지막 갱신: 2026-09-25 11:14 UTC (Claude 품질 계획 v2 세션: 운영 HERMES 무응답 한도 300초 반영)
...
- 서술형 CTA 측정 오탐(PR `fix/cta-noun-forms`, 사전 2026-09-25.12): fa9da73 게시 뒤 R3 재채점 warn 4건 중 3건(판매처, '주문하기 어려움', 검수의 지적·확인 뒤 삽입)을 고친다. 남는 1건은 조건 없는 '[가격 확인 필요]' CTA(설계대로 경고).
