...
마지막 갱신: 2026-09-24 17:06 UTC (Claude 트랙 R 계획 세션, OFD R0 준비도 확인·개발 제안서 개정 초안)
...
| `origin/main` | `df7e253` (#76) | aa999c6 뒤 **미게시 제품 변경 있음**: #59 B2 1단계, #60 PR 4a-2, #61 PR 5c, #62 B3-1, #63 F5, #64 B5, #65 PR 6c, #67 결정 17, #68 레인 A 입력 최소화, #69 레인 B 입력 최소화, #70 F4b-2, #73 학습 경로 입력 최소화, #74 사용자 자료 가림(DP-3), #75 조사·학습 브랜드 정체성 가림, #76 설치기 CDP 점검. main 기준 `runtime-verified` 아님 |
...
| 열린 PR | #77 묶음 4 발행 기록(문서), #16 Android(draft, 제외) | GitHub 열린 PR 목록(GitHub MCP), 2026-09-24 15:23 UTC |
| main CI(`df7e253`) | passed · verify, e2e-smoke | GitHub Actions main 실행 36000789733(2026-09-24 12:47 UTC 완료) |
