...
마지막 갱신: 2026-09-24 00:22 UTC (Claude 레인 B 세션, PR 4b-2)
...
| `origin/main` | `5ad24fc` (#52) | a64aeef 뒤 **미게시 제품 변경 있음**: #27 F1a·A2, #30 B4 1부, #32 F4a, #33 PR 6 서버 측, #35 F1b-1, #37 PR 5a, #39 F1b-2 서버 평가, #40 PR 5b, #41 동결 요약 표시, #43 F2a, #44 PR 4b-1, #45 F2b, #46 A4-1, #47 PR 6 앱 측, #48 PR 4a, #49 A4-2, #50 A4-3, #52 A2 런타임. main 기준 `runtime-verified` 아님 |
...
| 열린 PR | #16 Android(draft, 제외), #51 B1 검토 결정 로그(레인 A), PR 4b-2 캠페인 성과 탭 귀속 집계(레인 B, 이 PR) | `gh pr list -R roybeee/Collective`, 2026-09-24 00:40 UTC |
