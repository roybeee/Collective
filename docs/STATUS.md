...
- 대표 결정 대기(권장값으로 진행 중): (1) 앱 밖 모집 자료의 AI 생성물 표시(권장: 원문에 자동으로 붙이지 않고 출처·AI 도움 여부만 저장, 화면에서 표시 문구 확인), (2) 예비창업자용 고정 안내 문장(권장: 현재 문장, LR-1 회신 뒤 버전 올림).
