...
마지막 갱신: 2026-09-25 23:25 UTC (Claude 트랙 R 세션: 묶음 13 `b0ef304` 게시 보류(대표 결정), 자동 게시 2차 실행 없음)
...
| 열린 PR | #16 Android(draft, 제외), #120 A1 로컬 채널 스킬 팩(다른 도구), 묶음 13 게시 보류 기록 #119(라벨 없음, 브랜치 `claude/franchise-recruitment-marketing-u8cpo2`, 이 갱신과 같은 PR) | GitHub 열린 PR 목록(GitHub MCP), 2026-09-25 23:2x UTC |
