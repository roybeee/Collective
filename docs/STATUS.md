...
마지막 갱신: 2026-09-25 02:33 UTC (Claude 트랙 R 계획 세션, R4a 구현)
...
| `origin/main` | `a41624d` (#83) | 443fff4 뒤 **미게시 제품 변경 있음**: #82 회의·브리프 제출 조립 내보내기(G1), #83 품질 측정 v2. main 기준 `runtime-verified` 아님 |
...
| 열린 PR | #84 AI 판정 기준·응답 파서·보정 통계(J1), #16 Android(draft, 제외) | GitHub 열린 PR 목록(GitHub MCP), 2026-09-25 00:38 UTC |
