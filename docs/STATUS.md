...
마지막 갱신: 2026-09-23 23:13 UTC (Claude 레인 B 세션, A4-3)
...
| `origin/main` | `07e2c97` (#49) | a64aeef 뒤 **미게시 제품 변경 있음**: #27 F1a·A2, #30 B4 1부, #32 F4a, #33 PR 6 서버 측, #35 F1b-1, #37 PR 5a, #39 F1b-2 서버 평가, #40 PR 5b, #41 동결 요약 표시, #43 F2a, #44 PR 4b-1, #45 F2b, #46 A4-1, #47 PR 6 앱 측, #48 PR 4a, #49 A4-2. main 기준 `runtime-verified` 아님 |
...
| 열린 PR | #16 Android(draft, 제외), A4-3 추적 코드 직접 입력(레인 B, 이 PR) | `gh pr list -R roybeee/Collective`, 2026-09-23 23:20 UTC |
| main CI(`07e2c97`) | passed · verify | GitHub Actions main 실행 |
