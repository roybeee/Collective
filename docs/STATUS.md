...
- 운영: `98f2283`(Sites 버전 41, tree `d11b2e1`, [기록](releases/2026-09-27-98f2283.md)).
- **묶음 16 게시 요청 중**(레인 A, 2026-09-26 19:03 UTC): `a8edf10`(tree `5705e55`). 싣는 제품 PR: A8-1·2·3(#150·#152·#153, 스위치 `a8_customer_report` 기본 꺼짐), #154(카피 팩 스키마 순서), #155(B4-2a 순수 모듈, 연결 없음). 문서 #151.
...
마지막 갱신: 2026-09-26 19:03 UTC (Claude A 세션: 묶음 16 `a8edf10` 자동 게시 요청)
