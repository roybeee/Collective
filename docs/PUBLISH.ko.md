...
- 네 번째 요청(묶음 14, 2026-09-26 05:16:35 UTC push → 05:32 UTC 전 결과 댓글): `published`(real, Sites 버전 40, 약 15분, [게시 기록](releases/2026-09-26-8651021.md)). 시작 tree는 요청 전에 소유자 세션 Chrome 확장으로 확인했다. 게시 뒤 `/api/version/public` curl과 소유자 `/api/version` 모두 목표 tree와 일치했다.
