...
check('the grading version moves past measure-v2 with the G3 graders, dictionaries and compound failure labels',()=>assert.equal(GRADERS_VERSION,'failure-types-v1+normalized+measure-v2+g3+compound-labels'));
