...
const CONSUMER={'아메리카노 4,500원':'menu_price','일회용컵 보증금 300원':'menu_price','쿠키 3개 5,000원':'menu_price','베이킹 클래스 교육비 35,000원':'menu_price','멤버십 가입비 10,000원':'menu_price','로열티 카드 적립 시 아메리카노 4,500원':'menu_price','영업시간 10:00-21:00':'hours','9월 1일 오픈':'opening_date','02-000-0000':'phone','가상시 가상구 가상로 12':'address'};
