...
check('the two R15a kinds declare retention and no subject erasure, hang off the brand and stay outside campaign deletion',recruitment.every(k=>k&&k.retention&&k.retention.basis==='policy'&&typeof k.retention.anchor==='string'&&k.retention.anchor.length>0&&k.retention.days===null&&typeof k.retention.ref==='string'&&k.retention.ref.length>0&&k.subjectErasure==='none'&&k.parent==='brand'&&k.campaignDeletion==='not_campaign_scoped'&&!k.links&&k.purge===undefined&&!k.blocksDeletion&&/캠페인과 무관/.test(k.description)));
