...
// '2호점 오픈 기념'·'한정 12개'·'전국 5개 매장에서 한정 판매'는 매장 수 주장이 아니다. '오픈 대기 N곳'은 '오픈 예정'과 같다. '1년 만에 50호점'은 50호점이다. '100호점 계약 완료'는 100호점(이상), '전국 곳곳 120여 개 매장'은 전체 매장 수다(R2 5차 재검토).
