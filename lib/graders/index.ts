...
// '+r3-negation': 공용 부정 판정에 인용 조사 '(이)라고'(절 경계 아님), 확정 뒤로 미룬 승인·결정, 대상 앞 금지·거절 수식('금지된 “…”')을 더했다(R3 기준선 실측). unsupported_claim_term·fact_conflict 판정이 바뀌었다.
export const GRADERS_VERSION='failure-types-v1+normalized+measure-v2+g3+compound-labels+absent-expr+critique-clause+r3-negation';
