...
export const brandDefaults:Brand[] = [
 ...
 {id:'oda',name:'ODA Pizza',short:'ODA',category:'CONTEMPORARY PIZZA',color:'#bf442b',bg:'#f9e5dd',description:'대표님 대화 기반 소개(조리 설비·방식과 도우 특징은 미확인). 일상에서 즐기는 contemporary pizza.',audience:'합리적인 가격으로 완성도 있는 한 끼를 찾는 고객',tone:'젊고 감각적, 친근하고 선명한',constraints:'실제 메뉴와 가격 확인. 배달 수수료와 상품 원가를 고려.',knowledge:'볼드 타이포그래피와 명확한 그래픽. 매장·포장·배달에서 일관된 매력.\n초기 브랜드 정보: 대표님 대화 기반. 현재 판매 메뉴는 별도 확인.'},
