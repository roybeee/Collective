...
import {aiBrand,type EvidenceContext} from './ai-context';
import {directivePolicy} from './campaign-policy';
import {PRACTICE_VERSION,rolePractice,evidenceDiscipline,campaignPractice} from './practice';
import {qualityContract} from './quality';
import {roles,type Campaign,type Brand,type Artifact} from './agency';
...
export type RoleRequest={role:string;campaign:Campaign;brand:Brand;archive:{confirmedSources?:object[]};evidence:Pick<EvidenceContext,'facts'|'directives'>;learning:unknown;previous:Artifact[];previousDecisions?:PreviousDecisions;revisionRequest?:RevisionRequest};
