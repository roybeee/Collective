...
export async function GET(req:Request){try{return json({...await workerStatus(identity(req)),canInstall:!!runtime.RESEARCH_WORKER_GATE_TOKEN&&!!runtime.RESEARCH_WORKER_SITE_ORIGIN})}catch(e){return failure(e)}}
